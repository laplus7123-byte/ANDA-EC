    ...
    if (!items.length) {
      root.innerHTML = `
        <div class="page-empty">
          <p>カートに商品が入っていません。</p>
          <p style="margin-top:16px"><a href="${ANDA.routes ? ANDA.routes.categories() : "categories.html"}" class="anda-btn" style="width:auto;display:inline-flex">商品を見る</a></p>
        </div>`;
      return;
    }
    ...
    root.innerHTML = `
            ...
            ${items
              ...
              <tr>
                <td class="cart-product">
                  <a href="${ANDA.routes ? ANDA.routes.product(i.product.id) : `product.html?id=${i.product.id}`}">
      ...
      <div class="cart-summary">
        ...
        <div style="margin-top:16px;display:flex;flex-wrap:wrap;gap:10px">
          <a href="${ANDA.routes ? ANDA.routes.catalog("all") : "catalog.html?cat=all"}" class="anda-btn" style="width:auto;background:#fff;color:#1A3348!important;border:1px solid rgba(26,51,72,.2)">買い物を続ける</a>
