    ...
    el.innerHTML = `
      <div class="cart-toast__inner">
        ...
        <div class="cart-toast__actions">
          ...
          <a href="cart.html" class="cart-toast__btn cart-toast__btn--primary">カートを見る</a>
        </div>
      </div>`;
      ...
      if (qty > 0) {
        return `
          <div class="product-actions is-in-cart" data-product-actions="${productId}">
            ...
            <a href="product.html?id=${productId}" class="product-actions__detail">詳細を見る</a>
          </div>`;
      }
      return `
      ...
      if (qty > 0) {
        return `
          <div class="product-detail_buy is-in-cart" data-product-buy="${productId}">
            ...
            <a href="cart.html" class="anda-btn anda-btn-primary" style="width:auto;min-width:160px">カートを見る</a>
          </div>`;
      }
      return `
